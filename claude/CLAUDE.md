...
원본: `my-settings/claude/CLAUDE.md` — bootstrap이 `~/.claude/CLAUDE.md`로 복사(수정 시 레포에 반영).
모든 프로젝트·세션 공통 개인 기본값. 프로젝트별 규칙은 각 레포의 CLAUDE.md에 둔다.
...
<!-- 구체 사례는 겪을 때마다 아래에 축적하여 경계 케이스로 규칙을 정교화한다 -->
